...
return [
    ...
    'components' => [
        ...
        'db' => [
            ...
            'connectionString' => 'mysql:host=db1.csrew4qrtkkz.ap-south-1.rds.amazonaws.com;dbname=medikoma',
            'emulatePrepare'   => true,
            'username'         => 'dbroot',
    ...
    'params'     => [
        'server_ip'        => 'https://medikoma.com',
        'server_socket_notification_port'        => '3005',
